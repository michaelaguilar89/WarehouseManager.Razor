        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductNameHash = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Batch = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BatchHash = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ModificationAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UserIdCreation = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserIdModification = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tank = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FinalLevel = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModificacionTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UserIdCreation = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserIdModification = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Comments = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
